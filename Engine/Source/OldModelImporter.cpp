...
//#include <iostream>
//
//void OldModelImporter::ProcessAssimpMesh(const aiScene* scene, aiMesh* mesh, Mesh* myMesh, uint32_t baseMeshMaterialIndex, std::vector<uint32_t>& submeshMaterialIndices)
//{
...
//}
//
//void OldModelImporter::ProcessAssimpMaterial(App* app, aiMaterial* material, Material& myMaterial, std::string directory)
//{
//    aiString name;
...
//}
//
//void OldModelImporter::ProcessAssimpNode(const aiScene* scene, aiNode* node, Mesh* myMesh, uint32_t baseMeshMaterialIndex, std::vector<uint32_t>& submeshMaterialIndices)
//{
//    // process all the node's meshes (if any)
//    for (unsigned int i = 0; i < node->mNumMeshes; i++)
//    {
//        aiMesh* mesh = scene->mMeshes[node->mMeshes[i]];
//        OldModelImporter::ProcessAssimpMesh(scene, mesh, myMesh, baseMeshMaterialIndex, submeshMaterialIndices);
//    }
//
...
//}
//
//std::shared_ptr<Model> OldModelImporter::LoadModel(App* app, const char* filename)
//{
